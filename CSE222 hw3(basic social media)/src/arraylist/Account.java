...
public class Account {
		...
		private ArrayList<Account> blocked = new ArrayList();
		
		/**
		 * It is used for user's action history such as like, comment
		 */
		...
		public Account(int accountId, String username, String birthdate, String location, ArrayList<Account> accounts) {
